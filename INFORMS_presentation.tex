...
\ifshowcitations
	...
	\addbibresource{abm_presentation.bib}
	% \bibliography{hpo_presentation.bib}
...
\setbeamertemplate{footline}
{
	...
	\usebeamerfont{title in head/foot}{\href{https://sol.research.mcgill.ca/}{https://sol.research.mcgill.ca/}}
	\end{beamercolorbox}%
...
\title[]{Optimization of Stochastic Epidemiological Models for Disease Control and Prediction} % The short title appears at the bottom of every slide, the full title is only on the title page

\author[Journ\'{e}es de l'optimisation 2022]{Dr. Khalil Al Handawi\\{\footnotesize Joint work with: Prof. Michael Kokkolaras}} % Your name

\institute[McGill]% Your institution as it will appear on the bottom of every slide, may be shorthand to save space
{
	~\\
	\textit{\small
	Journ\'{e}es de l'optimisation 2022\\} % Your institution for the title page
}
...
\include{01_1_background}

% Section 02: problem formulation
\include{01_2_problem_formulation}

% Section 03: mads_overview
\include{01_3_mads_overview}

% Section 04: results
\include{01_4_results}

% Section 05: conclusion
\include{01_5_conclusion}
...
% Section 01: background
\include{02_1_introduction}

% Section 02: motivation
\include{02_2_motivation}

% Section 03: hyperparameters
\include{02_3_hyperparameter_tuning}

% Section 04: results
\include{02_4_results}

% Section 05: conclusion
\include{02_5_conclusion}
